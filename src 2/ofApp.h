...
public:
    ...
    void assignFileToSurface(const ofFile& file);
    bool isImageFile(const std::string& fileExtension);
    bool isAudioFile(const std::string& fileExtension);
    bool isVideoFile(const std::string& fileExtension);
    bool isSequenceFolder(const ofFile& folder);
     */
